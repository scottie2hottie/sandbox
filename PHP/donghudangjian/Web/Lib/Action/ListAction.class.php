...
class ListAction extends CommonAction 
{
	public function index()
	{
		...
		$model  = M('arctype');
		$list = $model->field('id as typeid,modeltype,modelid,linkurl,typename as title,typename,seotitle,keywords,description,content,tempindex,templist,waptempindex,waptemplist')->where($map)->find();
