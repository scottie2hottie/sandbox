...
/***********************************************************
	...
	@function Admin组 模板管理组

    @Filename TplManageAction.class.php $
...
class TplManageAction extends CommonAction
{
	...
	public function doadd()
	{
		...
		$from = empty($_POST['from']) ? U('TplManage/index') : $_POST['from'];
